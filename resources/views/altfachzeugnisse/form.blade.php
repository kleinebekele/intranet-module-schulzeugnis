<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            ...
            <div>
                <h1 class="text-xl font-semibold text-gray-800">Alte Fachzeugnisse umwandeln</h1>
                <p class="text-sm text-gray-500">A4-PDF duplex-tauglich machen (Leerseite bei ungerader Seitenzahl)</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-xl space-y-4">
        ...
        <form method="POST" action="{{ route('module.schulzeugnis.altfachzeugnisse.umwandeln') }}"
